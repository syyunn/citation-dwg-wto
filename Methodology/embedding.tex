\begin{figure}[t!]
    ...
    \end{tikzpicture} 
    \caption{\textbf{Output of Embedding Layer:} This figure illustrates an output of the embedding layer. Embedding layer maps each token in the input document to the specified numerical vector in dimension $k$.}
    \label{fig:embedding}       
\end{figure}
