\begin{figure}[ht]
  ...
  {``\textbf{Dual Retail System} allows imported beef to be sold only in specialized store \ldots ''};
    ...
    {``\textbf{Article I:1} \ldots members \textit{shall not} discriminate between different members of WTO \ldots''};
    ...
    \begin{scope}[xshift=16cm, yshift=-1.5cm]
      \node [draw, align=center,
        ...
        aspect = 2, 
        above left = 1.2 ]
      {Article I:1 of GATT 1994 is\\ \textbf{\textit{not} appropriate to be cited} \\ \textit{because} this measure \\ described in factual aspect \\ doesn't discriminate between \\ different members of WTO };
    \end{scope}      
  \end{scope}
\end{tikzpicture}
