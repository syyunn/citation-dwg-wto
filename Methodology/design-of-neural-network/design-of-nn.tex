\begin{figure}[ht]
    ...
    \begin{tikzpicture}[font=\sffamily,
        ...
        \begin{scope}[xshift=-8cm, yshift=2cm]
            ...
            {Neural network keeps estimating how much given legal article is citable for given factual aspect in probability};


        \end{scope}
    \end{tikzpicture}
    \caption{\textbf{Design of Training Framework of Deep Neural Network:} I desgined a training framework of deep neural network by an analogy to how member cites visualized in Figure \ref{fig:viz:how-member-cites-citable} and Figure \ref{fig:viz:how-member-cites-non-citable}.}
