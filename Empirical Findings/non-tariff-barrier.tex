...
Therefore, Article XXIII regulates the action-reaction characteristics of \textit{AD}, \textit{CVD} and \textit{SG} to achieve the priniple of \textit{Reciprocity}. % as shown in Figure \ref{fig:ntb-explained}.
