...
Therefore, \textit{Article XXIII} regulates this action-reaction characteristics of \textit{AD}, \textit{CVD} and \text{SG} to achieve the priniple of \textit{reciprocity} in WTO DSB as shown in Figure \ref{fig:ntb-explained}.
