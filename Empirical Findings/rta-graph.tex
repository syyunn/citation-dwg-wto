\begin{tikzpicture}[
    ...
    \node[state, label=left:{\hspace{1mm} Consultation}] at ([shift=({240:3 cm})]T1) (T2) {XXII};
    \node[state, label=left:{\hspace{3mm} Modification of Schedules}] at ([shift=({120:3 cm})]T1) (T3) {XXVIII};
    \node[state, label=right:{\hspace{0mm} Non-Discriminatory Administration of \\[1mm]\hspace{7mm} Quantitative Restrictions}] at ([shift=({45:3 cm})]T1) (T4) {XIII};
    \node[state, label=right:{\hspace{8mm}Emergency Action on \\[1mm]\hspace{0mm} Imports of Particular Products\\[1mm]\hspace{10mm} (Safeguard)}] at ([shift=({-45:2.5 cm})]T1) (T5) {XIX};
