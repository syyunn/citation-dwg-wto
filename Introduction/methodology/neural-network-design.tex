...
After training, I fitted a set of directed edge weight $W^*$ that best explains the variance of the predictions from the trained neural network%for given $V$, $E$ % and collection of answers from the trained neural network (Figure \ref{predidction_matrix})
