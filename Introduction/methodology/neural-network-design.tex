...
After training, I collected all the answers from the neural network 
and created the network of legal articles of WTO agreement where the nodes are articles of the WTO agreement 
and edges are ranking the importance of incoming nodes to target nodes (Figure \ref{fig:market-aceess}).
