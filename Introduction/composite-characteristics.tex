...
% As the systematic interactions between articles of WTO agreements are formed as the Panel and Appellate Body express their judicial opinion in their report.
...
% that three major principles of WTO DSB, \textit{Market Access}, \textit{Reciprocity}, and \textit{Non-discrimination}, are also clustered in the fitted network.
