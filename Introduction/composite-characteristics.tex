...
Upon these two considerations, this paper adopts a deep neural network as a technical soultion. % to effectively extract information from the text and to generalize the member specific startegic citation patterns.
