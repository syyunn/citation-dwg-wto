\begin{tikzpicture}[>={Stealth[color=black]},shorten >=1pt,node distance=2cm,on grid,initial/.style={}]
  ...
  \node[state, label={[align=center]right:National Treatment \\ on Internal Taxation}] at ([shift=({10:2.5 cm})]T4) (T6) {III:2};
  \node[state, label={[align=left]left:Fees Connected with \\ Importation and Exportation}] at ([shift=({150:5.5 cm})]T4) (T8) {VIII};
