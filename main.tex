...
% \subsection{\textit{Rules of Formulating Free Trade Area} (FTA): No Higher Duties or more Restrictive regulation than Previous duties and other Regulations}
\subsection{\textit{Rules of Formulating Regional Trade Agreements} (RTA): Non-discrimination, Transparency and Compensatory Adjustment}
% \subsection{\textit{Rules of Formulating Free Trade Area} (FTA) and Safeguard Measures: Do not discriminate   }
% \subsection{\textit{Non-Tariff Barriers}: Anti-dumping, Countervailing Duties and Safeguard}
