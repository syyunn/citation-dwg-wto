...
Figure \ref{fig:maxpool1d} illustrates this process. I used 128 ($=m$ in Figure) number of filters for each filter size, thus I got 3 differnt 128-dimensional vectors as a result of \textit{MaxPool1D}.
