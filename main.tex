...
Human reads the text line by line and creates several local understandings.
Then he/she merges those local understandings into a global level to summarize 
an essential information that is enough to peform a subsequent logical task.

To analogy this local and global level of information gathering, I borrowed \textit{1-Dimensional Text Convolution Neural Network} (TextCNN) from \cite{textcnn}.
