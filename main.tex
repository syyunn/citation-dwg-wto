...
% It's worth noting that I prepared two seperate embedding layers for \textit{Fatcutal Aspect} and \textit{Legal Article} each.
% Although both of them are initialized with the same Googld News Word2Vec, however, they are trained independently as trains goes by. 
% This is because I had an background knwoledge that the 
