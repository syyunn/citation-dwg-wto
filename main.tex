...
Before training, I randomly split the entire dataset into train and test data in 8:2 ratio. 
...
metric on the inference result of the test data, one can check the generalizability of the trained neural network.
