...
Then I \textit{padded} a special token \textbf{[PAD]} at the tail in case the token length of a factual aspect or legal article is shorter than those \textit{max token lengths}.
