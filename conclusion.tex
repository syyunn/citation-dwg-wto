...
% we can understand this network captures the important interactions with
...
% Regulatory system of WTO DSB is notorious for its complexity because it is designed to evolve with the actual use cases. 
